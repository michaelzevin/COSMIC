...
*
      ...
      LOGICAL COEL,output
      REAL*8 CELAMF,CELAMF_NANJING,RL,RZAMSF
      EXTERNAL CELAMF,CELAMF_NANJING,RL,RZAMSF
*
...
*
      IF(LAMBDA.GE.0.0.AND.LAMBDA.LE.1.0)THEN
         LAMB1 = CELAMF_NANJING(KW,M01,MENVD,ZPARS,R1,RZAMS,LAMBDA)
      ELSEIF(LAMBDA.EQ.2.0)THEN
...
*
      IF(KW2.GE.2.AND.KW2.LE.9.AND.KW2.NE.7)THEN
         ...
         RZAMS = RZAMSF(M02)
         IF(LAMBDA.GE.0.0.AND.LAMBDA.LE.1.0)THEN
            LAMB2 = CELAMF_NANJING(KW,M02,MENVD,ZPARS,R2,RZAMS,LAMBDA)
         ELSEIF(LAMBDA.EQ.2.0)THEN
